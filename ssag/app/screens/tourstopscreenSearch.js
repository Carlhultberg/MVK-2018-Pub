...
class TourstopScreenSearch extends React.Component {
  ...
  renderTourStops(songs) {
    ...
    return this.state.tourstops.map(tourstops =>
       <TourStopDetailsSearch key={tourstops.text} text={tourstops.text} number={tourstops.number} thisIndex={tourstops.thisIndex} addAudioPlayer={()=>this.props.screenProps.addAudioPlayer(tourstops.filePath, array, tourstops.thisIndex, maxIndex, tourstops.text, tourstops.number)} array={array}/>
     );
  }
